<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aceeditor_php.aspx.cs" Inherits="julia.web.aceeditor_php" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
     ...
     function inite(){
            ...
            myeditor.setTheme("ace/theme/dreamweaver");    
            myeditor.getSession().setMode("ace/mode/python");
