<%@ WebHandler Language="C#" Class="julia.web.gettree_json" %>
using System;
using System.Web;
...
namespace julia.web
{
    public class gettree_json : IHttpHandler
    {
        ...
        private static DataTable getchildtree(String id)
        {
          ...
          " WHERE (trid IN " +
                   ...
                   " WHERE (ROLENUM IN " +
                            ...
                            " FROM USERROLES INNER JOIN " +
                                  " USERS ON USERROLES.USERNUM = USERS.USERNUM " +
                            " WHERE (USERS.USERNAME = '" + userName + "'))))) and parentid = " + id + " ";
