<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main_new.aspx.cs" Inherits="julia.web.main_new" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="jquery-easyui-1.2.6/jquery.easyui.min.js"></script> 
      <link href="jquery-easyui-1.2.6/themes/sunny/easyui.css" rel="stylesheet" type="text/css" />   
...
<body class="easyui-layout">  
	...
	<div region="south"  split="false" style="height:50px;padding:10px;">
